...
class CldrData
{
    ...
    private static function getData($key)
    {
        if (!isset(self::$data)) {
            ...
            $data = array();
            $json = json_decode(file_get_contents(__DIR__ . '/cldr-data/main/en-US-POSIX/languages.json'), true);
            $data['languages'] = $fixKeys($json['main']['en-US-POSIX']['localeDisplayNames']['languages']);
            $json = json_decode(file_get_contents(__DIR__ . '/cldr-data/main/en-US-POSIX/territories.json'), true);
            $data['territories'] = $fixKeys($json['main']['en-US-POSIX']['localeDisplayNames']['territories']);
            ...
            $json = json_decode(file_get_contents(__DIR__ . '/cldr-data/main/en-US-POSIX/scripts.json'), true);
            $data['scripts'] = $fixKeys($json['main']['en-US-POSIX']['localeDisplayNames']['scripts'], $data['standAloneScripts']);
